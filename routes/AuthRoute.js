...
AuthRouter.post("/usercreate",UserRequest.validationRules(false),UserRequest.validate,authMiddleware.verifyaccount,AuthController.usercreate)
AuthRouter.post("/userstatus/:id",authMiddleware.verifyaccount,AuthController.userStatus)
